...
#Edited by Priya Kudva 11/22/17
...
class MyApp:
	def __init__(self, parent):
		...
		self.myParent.bind("<space>", self.button1Click)  # ajh
		self.myParent.bind("j", self.button2Click)  # ajh
		self.myParent.bind("k", self.button3Click)

		#Clickable button to move pointer left
		self.button1 = Button(self.myContainer1)
		# The background colors appear in Windows but not on a Macintosh.
		self.button1.configure(text="Left (space)", font=('Helvetica', 36) ,  background= "red", justify=LEFT)
		...
		self.button1.bind("<space>", self.button1Click)  #allow <j> to have same function

		#Clickable button to move pointer right
		self.button2 = Button(self.myContainer1)
		self.button2.configure(text="Right (j)", font=('Helvetica', 36), background="red", justify=RIGHT)
		self.button2.place(rely=1.0, relx=1.0, x=0, y=0, anchor=SE)
		self.button2.bind("<Button-1>", self.button2Click)
		self.button2.bind("j", self.button2Click)  #allow <k> to have same function

		self.button3 = Button(self.myContainer1)
		self.button3.configure(text="Select (k)", font=('Helvetica', 36), background="green", justify=CENTER)
		self.button3.place(rely=1.0, relx=0.5, x=0, y=0, anchor=S)
		self.button3.bind("<Button-1>", self.button3Click)
		self.button3.bind("k", self.button3Click) #allow <space> to have same function
